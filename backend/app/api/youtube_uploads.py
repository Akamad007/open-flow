...
_METADATA_SYSTEM = (
    ...
    "  the main subject and the hook (e.g. 'The Last Lighthouse Keeper — A Storm "
    "  at Dawn, 1901').\n"
    ...
    "      separated by single spaces (e.g. '#ShortFilm #Animation "
    "      #Storytelling #IndieFilm'). Use single-word or camelCase tags only.\n"
    "\n"
