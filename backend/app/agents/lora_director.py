...
def _build_system_prompt() -> str:
    ...
    return (
        ...
        "    For deities, enlightened monks, haloed mystics,\n"
        "    gods, demons, and powered-up beings.\n"
        "    Triggered by prompt language: 'halo', 'aureole', 'divine glow',\n"
        "    'enlightenment', 'cosmic vision', 'inner glow', 'awakened'.\n\n"
        ...
        "    desert, terraced paddy fields, hilltop views, rocky shoreline,\n"
